...
namespace RossQoL.Game.Progression
{
    ...
    internal sealed class DungeonRespawnFeature : Feature
    {
        ...
        public override IEnumerable<CompatMember> RequiredMembers => new[]
        {
            ...
            new CompatMember("DungeonGenerator", "m_themes", "what kind of dungeon it is, when its location says nothing"),
            new CompatMember("DungeonGenerator", "m_algorithm", "telling a real dungeon from a surface camp"),
            ...
            new CompatMember("Location", "m_biome", "the biome the dungeon belongs to, rather than the ground under it"),
            new CompatMember("ZoneSystem+ZoneLocation", "m_biome", "the same, from the world record, when the location is not loaded"),
